...
Provide the Package Check workflow in the ECC-Fusion routed system.

## Trigger

Use when the active command or route calls for `package-check`.
...
1. Validate package completeness and install safety.
2. Check commands, skills, manifests, schemas, rules, templates, docs, and README.
3. Report managed-file boundaries.
...
`package-check` should produce a compact result with route, rationale, blockers, and next command.
