...
> Generated mirror. Canonical source: `skills/03-Implementation/tdd/SKILL.md`.
...
Provide the TDD workflow in the ECC-Fusion routed system.

## Trigger

Use when the active command or route calls for `tdd`.
...
3. Refactor only after green verification.
...
`tdd` should produce a compact result with route, rationale, blockers, and next command.
