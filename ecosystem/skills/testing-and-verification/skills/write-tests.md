...
> Generated mirror. Canonical source: `skills/04-Testing-and-QA/write-tests/SKILL.md`.
...
1. Map tests to AC IDs or observed regressions.
2. Prefer focused tests near the changed behavior.
3. Record gaps that cannot be automated now.
