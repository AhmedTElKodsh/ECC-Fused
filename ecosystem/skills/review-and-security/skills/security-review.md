...
> Generated mirror. Canonical source: `skills/05-Review-and-Release/security-review/SKILL.md`.
...
1. Threat-model changed surfaces.
2. Check secrets, auth, input, persistence, dependency, and deployment risks.
3. Escalate critical or high findings immediately.
