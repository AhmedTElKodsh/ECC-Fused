...
> Generated mirror. Canonical source: `skills/05-Review-and-Release/retro-learn/SKILL.md`.

| Field | Value |
| --- | --- |
| Skill id | `retro-learn` |
...
Provide the Retro Learn workflow in the ECC-Fusion routed system.

## Trigger

Use when the active command or route calls for `retro-learn`.
...
1. Summarize outcome, evidence, surprises, and process improvements.
2. Create follow-up items for unfinished work.
3. Keep blame out of the record.
...
`retro-learn` should produce a compact result with route, rationale, blockers, and next command.
